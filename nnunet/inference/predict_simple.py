...
def main():
    ...
    parser.add_argument("--num_parts", type=int, required=False, default=1,
                        help="Used to parallelize the prediction of "
                             ...
                             "GPU (via "
                             "CUDA_VISIBLE_DEVICES=X)")
    parser.add_argument("--model_folder_name", type=str, required=False, default="",
                        help="folder where my own model is saved")
    ...
    parser.add_argument("--my_own_model", required=False, default=False, action="store_true",
                        help="whether use my own model "
                             "by roughly factor 4 (2D) or 8 (3D)")
    ...
    model_folder_name = join(network_training_output_dir, model, task_name, trainer + "__" +
                              args.plans_identifier)
    if args.my_own_model:
        print('using my own model:.........')

...
def main():
    ...
    for i in task_ids:
        ...
        print('task_name',task_name,i)

        if args.verify_dataset_integrity:
            verify_dataset_integrity(join(nnUNet_raw_data, task_name))

        crop(task_name, False, tf) # what is crop for?
    ...
    if planner_name3d is not None:
        ...
        # print("planner_3d",planner_3d)  nnunet.experiment_planning.experiment_planner_baseline_3DUNet_v21.ExperimentPlanner3D_v21
    ...
    for t in tasks:
        # print("\n\n\n", t)  # Task001_STN
        # print(nnUNet_cropped_data) # .DATASET/nnUNet_raw/nnUNet_cropped_data
        cropped_out_dir = os.path.join(nnUNet_cropped_data, t) # .DATASET/nnUNet_raw/nnUNet_cropped_data/Task001_STN
        print('cropped_out_dir',cropped_out_dir)
        preprocessing_output_dir_this_task = os.path.join(preprocessing_output_dir, t)
        # print(preprocessing_output_dir_this_task) #.DATASET/nnUNet_preprocessed/Task001_STN
        ...
        print("planner_3d ",planner_3d)

        if planner_3d is not None:
            print(args.overwrite_plans)
            if args.overwrite_plans is not None:

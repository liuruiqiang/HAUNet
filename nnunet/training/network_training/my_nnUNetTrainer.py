...
class my_nnUNetTrainer(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        """
        super(my_nnUNetTrainer, self).__init__(deterministic, fp16)
    ...
    def save_debug_infomation(self):
        # save some debug infomation
        dct = OrderedDict()
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        super(my_nnUNetTrainer, self).save_checkpoint(fname, save_optimizer)
        info = OrderedDict()
